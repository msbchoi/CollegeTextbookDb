		        ...
		        <div class="container v-align-transform">
		            <div class="row">
		                <div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
		                    <h1 class="mb8">Search for Textbooks</h1>
		                    <p class="lead mb48">
		                        You can search by class names or course ID numbers </p>
		                        <input type="text" id = "Classinput" class="validate-required validate-email signup-email-field " placeholder="Class Name or Course ID">
